i have generated questions from a set of ebooks and the questions are extracted in json files with the same name of the book. You need to now create a system which extracts the answers from the ebook in the ./files/ folder. question jsons are in ./questions_from_ebooks/
The name of the json for questions is the same name of the ebook pdf.

This was the code used to extract the questions

write a program to answer the questions. the answers MUST be from the ebook only and not the existing LLM knowledge.
